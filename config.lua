...
maxPlayers = 200
motd = "Bem-vindo ao DBOZ Online, divirta-se!"
displayOnOrOffAtCharlist = false
onePlayerOnlinePerAccount = false
allowClones = false
serverName = "Rox"
loginMessage = "Bem-vindo ao DBOZ Online, divirta-se!"
